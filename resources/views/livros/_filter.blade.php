@php
    $rotaFiltro = Route::currentRouteName() === 'livros.venda' ? route('livros.venda') : route('livros.index');
@endphp
        ...
        <div class="card-body">
            <div class="form-row row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control bg-dark text-white border-danger" id="autor"
                        name="autor" value="{{ request('autor') }}">
                </div>
                <div class="form-group col-md-2">
                    <label for="editora">Editora</label>
                    <input type="text" class="form-control bg-dark text-white border-danger" id="editora"
                        name="editora" value="{{ request('editora') }}">
                </div>
                <div class="form-group col-md-2">
