@php
    $rotaFiltro = Route::currentRouteName() === 'alimentos.venda' ? route('alimentos.venda') : route('alimentos.index');
@endphp
        ...
        <div class="card-body">
            <div class="form-row row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control bg-dark text-white border-danger" id="validade"
                        name="validade" value="{{ request('validade') }}">
                </div>
                <div class="form-group col-md-3">
