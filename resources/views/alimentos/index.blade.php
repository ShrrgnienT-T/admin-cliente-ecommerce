        ...
        <div class="card border-0 shadow-lg mb-4"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="fw-bold" style="text-shadow:1px 1px 6px #000, 0 0 2px #ff003c;">Alimentos</h2>
                    <a href="{{ route('alimentos.create') }}" class="btn fw-bold"
                        style="background:#ff003c;color:#fff;box-shadow:0 2px 8px #2d0b0b;">Novo Alimento</a>
                </div>
                    ...
                    <table class="table table-dark table-striped align-middle" style="border-radius:10px;overflow:hidden;">
                        ...
                        <tbody>
                            @foreach ($alimentos as $alimento)
                                <tr>
                                    <td><img src="{{ $alimento->imagem }}" alt="Imagem"
                                            style="width:60px;height:60px;object-fit:cover;border-radius:8px;">
                                    </td>
                                    <td class="fw-semibold" style="text-shadow:1px 1px 4px #000;">{{ $alimento->id }}
                                    </td>
                                    <td class="fw-semibold" style="text-shadow:1px 1px 4px #000;">{{ $alimento->nome }}
                                    </td>
                                    <td class="fw-semibold" style="color:#ff003c;text-shadow:1px 1px 4px #000;">
                                        R$ {{ number_format($alimento->preco, 2, ',', '.') }}</td>
                                    <td class="fw-semibold" style="text-shadow:1px 1px 4px #000;">{{ $alimento->validade }}
                                    </td>
                                    <td>
